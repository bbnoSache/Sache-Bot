...
bot.on('message', msg =>{
    ...
    switch(args[0]){
        ...
        case '!addrole':
            ...
            if(!args[2]) return msg.channel.send('What role do you wanna add?')
        ...
        case '!removerole':
            ...
            if(!member2) return msg.channel.send("Please specify a user.")
            if(!args[1]) return msg.channel.send('What?')
            if(!args[2]) return msg.channel.send('What role do you wanna remove?')
